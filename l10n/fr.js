OC.L10N.register(
    ...
    "Standard signature is possible only with PDF files" : "La signature standard n’est possible qu’avec des fichiers PDF",
    ...
    "Digital seal of file" : "Scellement numérique du fichier",
    "Seal" : "Sceller",
    "You have to enter the OpenOTP server URL in the OpenOTP Sign settings prior to seal any document" : "Vous devez entrer l’URL du serveur OpenOTP dans les paramètres de OpenOTP Sign avant de sceller tout document",
    ...
    "Enable default types" : "Activer les types par défaut",
    "Enable Standard signature" : "Activer la signature Standard",
    "Enable Advanced signature" : "Activer la signature Avancée",
    "Cannot sign with disabled Sign type" : "Impossible de signer avec un type de signature désactivé",
    "Cannot sign when all signature types are disabled" : "Impossible de signer lorsque tous les types de signature sont désactivés",
    "Request failed with status code 500" : "Requête échouée avec un code de retour 500",
    "Signature" : "Signature",
    "Signature types" : "Types de signature",
    "OpenOTP methods" : "Méthodes OpenOTP",
    "Enable OpenOTP signature" : "Activer la signature OpenOTP",
    "Enable OpenOTP seal" : "Activer le scellement OpenOTP",
    "Sign process is disabled" : "Le processus de signature est désactivé",
    "Seal process is disabled" : "Le processus de scellement est désactivé",
    "Something went wrong during this process" : "Quelque chose s'est mal passé pendant ce processus"
},
